...
# 🎯 戦略的発言ガイドライン
**表面的な議論を避け、具体的で戦略的な発言をしてください:**
1. **具体的な根拠**: 「なんとなく怪しい」ではなく「○○の発言で△△という矛盾があった」
2. **明確な推理**: 「○○さんが人狼だと思う理由は□□です」のように論理的に説明
3. **積極的な提案**: 「次は○○さんを占うべき」「○○さんに投票すべき」など具体的行動を提案
4. **情報の整理**: これまでの占い結果、投票結果、発言の変化を分析して共有
5. **決断力**: 迷いを見せず、確信を持った発言で議論をリード

**避けるべき表面的発言:**
- 「様子を見ましょう」「もう少し情報が欲しい」
- 「みんなで協力しましょう」「平和に行きましょう」
- 「まだよくわからない」「判断が難しい」
